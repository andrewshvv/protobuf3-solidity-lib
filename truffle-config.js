 ...
 * @truffle/hdwallet-provider) to sign your transactions before they're sent to
 * a remote public node. Infura accounts are available for free at:
 * infura.io/register.
 *
...
module.exports = {
  ...
  networks: {
    // Useful for testing. The `development` name is special - truffle uses it
    // by default
    ...
    // from: <address>,        // Account to send txs from (default:
    // accounts[0])
